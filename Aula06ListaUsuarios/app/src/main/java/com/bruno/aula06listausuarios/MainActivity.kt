package com.bruno.aula06listausuarios

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import androidx.recyclerview.widget.LinearLayoutManager
import androidx.recyclerview.widget.RecyclerView
import layout.UsuarioAdapter
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val lista = mutableListOf<Usuario>(
            Usuario(nome="Bruno", email="bruno@gmail.com", stack= Stack.FRONTEND, senioridade= Senioridade.JUNIOR, foto=resources.getDrawable(R.drawable.grimm)),
